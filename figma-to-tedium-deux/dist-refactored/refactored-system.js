...
function getComponentSetFromInstance(instance) {
    return __awaiter(this, void 0, void 0, function () {
        var components, mainComponent, componentSet, parent_1, variants, propertyValue, property1, componentFromInstance, error_1;
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (componentSet && componentSet.type === 'COMPONENT_SET') {
                        ...
                        propertyValue = 'start';
                        try {
                            property1 = instance.componentProperties['Property 1'];
...
function buildComponentSetHTMLAsync(node_1) {
    return __awaiter(this, arguments, void 0, function (node, overrideData, parentNode) {
        var componentSetComponents, componentHTMLs, containerWidth, containerHeight, sizingAttributes, containerAttributes, containerOpenTag, containerCloseTag;
        var _this = this;
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.all(componentSetComponents.map(function (component, index) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        if (!component.isInstanceComponent) return [3 /*break*/, 2];
                                    ...
                                    case 1:
                                        ...
                                        if (componentHTML.includes('style="')) {
                                            ...
                                            componentHTML = componentHTML.replace(/style="([^"]*)"/, function (match, styleContent) {
                                                ...
                                                return "style=\"".concat(updatedStyle, "\"");
                                            });
                                        }
                                        // Add visibility control classes for variants
                                        if (index === 0) {
                                            // First variant should be visible initially
                                            return [2 /*return*/, componentHTML.replace('<div', '<div class="variant-active"')];
                                        }
                                        else {
                                            // Other variants should be hidden initially
                                            return [2 /*return*/, componentHTML.replace('<div', '<div class="variant-hidden"')];
                                        }
                                        // removed by dead control flow
{}
                                    case 2: return [4 /*yield*/, buildComponentSetHTMLAsync(component, overrideData, parentNode)];
                ...
                case 2:
                    ...
                    containerWidth = node.width ? "".concat(node.width, "px") : '100%';
                    containerHeight = node.height ? "".concat(node.height, "px") : '100%';
                    sizingAttributes = [];
                    if (node.layoutSizingHorizontal) {
                        sizingAttributes.push("data-sizing-horizontal=\"".concat(node.layoutSizingHorizontal, "\""));
                    }
                    if (node.layoutSizingVertical) {
                        sizingAttributes.push("data-sizing-vertical=\"".concat(node.layoutSizingVertical, "\""));
                    }
                    containerAttributes = [
                        "data-figma-type=\"COMPONENT_SET\"",
                        "data-figma-id=\"".concat(node.id, "\""),
                        "data-figma-name=\"".concat(node.name, "\"")
                    ].concat(sizingAttributes).concat([
                        "style=\"position: relative; width: ".concat(containerWidth, "; height: ").concat(containerHeight, ";\"")
                    ]);
                    containerOpenTag = "<div ".concat(containerAttributes.join(' '), ">");
                    containerCloseTag = '</div>';
                    // Return all components wrapped in the container
                    return [2 /*return*/, "".concat(containerOpenTag).concat(componentHTMLs.join('\n')).concat(containerCloseTag)];
